// Package polaris provides Polaris configuration watcher implementation.
// This file implements the ConfigWatcher contract for change notification.
//
// 本包提供 Polaris 配置监听器实现。
...
// polarisWatcher implements datacontract.ConfigWatcher.
// Dispatches config change callbacks to registered handlers.
//
// polarisWatcher 实现 datacontract.ConfigWatcher。
// 将配置变更回调分发给注册的处理器。
