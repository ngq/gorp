...
type ProductPO struct {
	...
	OldPrice       float64   `gorm:"type:decimal(18,2);default:0;column:old_price" db:"old_price" json:"old_price"` // 原价
...
type CategoryPO struct {
	...
	ParentID    uint      `gorm:"default:0;column:parent_id;index" db:"parent_id" json:"parent_id"` // 父分类ID
...
type ProductReviewPO struct {
	...
	CustomerName string    `gorm:"size:64;column:customer_name" db:"customer_name" json:"customer_name"`   // 评论者名称
