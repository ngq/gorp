...
import (
	...
	"grpc-demo/services/user/internal/server/http/request"
	"grpc-demo/services/user/internal/server/http/response"
...
func (h *UserHandler) List(c gorp.HTTPContext) {
	...
	gorp.Success(c, response.UserList{
		Items: respItems,
		Total: total,
		Page:  page,
		Size:  size,
