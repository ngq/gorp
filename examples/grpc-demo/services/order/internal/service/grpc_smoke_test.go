...
func TestOrderServiceGetOrderUserPropagatesMetadataContext(t *testing.T) {
	ctx := gorp.AppendToClientContext(context.Background(), "x-md-demo", "hello-metadata")
	md, ok := gorp.FromClientContext(ctx)
	require.True(t, ok)
