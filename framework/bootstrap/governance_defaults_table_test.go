...
func TestBuildGovernanceDefaultsTableMonolithFeatureDefaults(t *testing.T) {
	table := BuildGovernanceDefaultsTable(resiliencecontract.GovernanceModeMono)
	require.NotNil(t, table)
	assert.Equal(t, resiliencecontract.GovernanceModeMono, table.Mode)
...
func TestBuildGovernanceDefaultsTableMicroserviceFeatureDefaults(t *testing.T) {
	...
	require.NotNil(t, table)
	assert.Equal(t, resiliencecontract.GovernanceModeMicro, table.Mode)
...
// TestBuildGovernanceDefaultsTableProviderDefaultsConsistency 验证两种模式 provider 默认值与代码一致。
func TestBuildGovernanceDefaultsTableProviderDefaultsConsistency(t *testing.T) {
	modes := []resiliencecontract.GovernanceMode{
		resiliencecontract.GovernanceModeMono,
		resiliencecontract.GovernanceModeMicro,
	}
...
func TestFormatGovernanceDefaultsDiagnosticOutput(t *testing.T) {
	...
	summary.Defaults = BuildGovernanceDefaultsTable(resiliencecontract.GovernanceModeMicro)
