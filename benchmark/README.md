...
|------|--------|---------|----------|-----------|
| **Random** | 41 ns | 158 ns | 1.1 µs | 11.3 µs |
| **WRR** | 118 ns | 666 ns | 5.2 µs | 48.6 µs |
| **P2C** | 82 ns | 228 ns | 1.1 µs | 12.5 µs |

**结论**：Random 最快（41 ns），P2C 性能接近（82 ns）且具备自适应能力，WRR 因权重计算较慢（118 ns）但支持负载分配。
